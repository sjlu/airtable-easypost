...
var createShipment = function (fromAddress, toAddress, type, opts) {
  return Promise
    .props({
...
module.exports.createShipment = function (toAddress, type, opts) {
  return createShipment(defaultAddress, toAddress, type, opts)
}

module.exports.createReverseShipment = function (toAddress, type, opts) {
  return createShipment(toAddress, defaultAddress, type, opts)
}
